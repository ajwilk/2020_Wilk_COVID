...
myJoin <- function (x, y, by.x, by.y, all.x = TRUE, all.y = TRUE) 
{
...
myMerge <- function(x,...){
  ...
  if (narg==2) {
    output.name <- myJoin(args[[1]], args[[2]], by.x = rownames(args[[1]]), by.y = rownames(args[[2]]), all.x = TRUE, all.y = TRUE)
    
    return(output.name)
  }
  if (narg==3) {
    output.name1 <- myJoin(args[[1]], args[[2]], by.x = rownames(args[[1]]), by.y = rownames(args[[2]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name1, args[[3]], by.x = rownames(output.name1), by.y = rownames(args[[3]]), all.x = TRUE, all.y = TRUE)
    
    return(output.name)
  }
  if (narg==4) {
    output.name1 <- myJoin(args[[1]], args[[2]], by.x = rownames(args[[1]]), by.y = rownames(args[[2]]), all.x = TRUE, all.y = TRUE)
    output.name2 <- myJoin(output.name1, args[[3]], by.x = rownames(output.name1), by.y = rownames(args[[3]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name2, args[[4]], by.x = rownames(output.name2), by.y = rownames(args[[4]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==5) {
    output.name1 <- myJoin(args[[1]], args[[2]], by.x = rownames(args[[1]]), by.y = rownames(args[[2]]), all.x = TRUE, all.y = TRUE)
    output.name2 <- myJoin(output.name1, args[[3]], by.x = rownames(output.name1), by.y = rownames(args[[3]]), all.x = TRUE, all.y = TRUE)
    output.name3 <- myJoin(output.name2, args[[4]], by.x = rownames(output.name2), by.y = rownames(args[[4]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name3, args[[5]], by.x = rownames(output.name3), by.y = rownames(args[[5]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==6) {
    ...
    output.name2 <- myJoin(output.name1, args[[3]], by.x = rownames(output.name1), by.y = rownames(args[[3]]), all.x = TRUE, all.y = TRUE)
    output.name3 <- myJoin(output.name2, args[[4]], by.x = rownames(output.name2), by.y = rownames(args[[4]]), all.x = TRUE, all.y = TRUE)
    output.name4 <- myJoin(output.name3, args[[5]], by.x = rownames(output.name3), by.y = rownames(args[[5]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name4, args[[6]], by.x = rownames(output.name4), by.y = rownames(args[[6]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==7) {
    ...
    output.name3 <- myJoin(output.name2, args[[4]], by.x = rownames(output.name2), by.y = rownames(args[[4]]), all.x = TRUE, all.y = TRUE)
    output.name4 <- myJoin(output.name3, args[[5]], by.x = rownames(output.name3), by.y = rownames(args[[5]]), all.x = TRUE, all.y = TRUE)
    output.name5 <- myJoin(output.name4, args[[6]], by.x = rownames(output.name4), by.y = rownames(args[[6]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name5, args[[7]], by.x = rownames(output.name5), by.y = rownames(args[[7]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==8) {
    ...
    output.name4 <- myJoin(output.name3, args[[5]], by.x = rownames(output.name3), by.y = rownames(args[[5]]), all.x = TRUE, all.y = TRUE)
    output.name5 <- myJoin(output.name4, args[[6]], by.x = rownames(output.name4), by.y = rownames(args[[6]]), all.x = TRUE, all.y = TRUE)
    output.name6 <- myJoin(output.name5, args[[7]], by.x = rownames(output.name5), by.y = rownames(args[[7]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name6, args[[8]], by.x = rownames(output.name6), by.y = rownames(args[[8]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==9) {
    ...
    output.name5 <- myJoin(output.name4, args[[6]], by.x = rownames(output.name4), by.y = rownames(args[[6]]), all.x = TRUE, all.y = TRUE)
    output.name6 <- myJoin(output.name5, args[[7]], by.x = rownames(output.name5), by.y = rownames(args[[7]]), all.x = TRUE, all.y = TRUE)
    output.name7 <- myJoin(output.name6, args[[8]], by.x = rownames(output.name6), by.y = rownames(args[[8]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name7, args[[9]], by.x = rownames(output.name7), by.y = rownames(args[[9]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==10) {
    ...
    output.name6 <- myJoin(output.name5, args[[7]], by.x = rownames(output.name5), by.y = rownames(args[[7]]), all.x = TRUE, all.y = TRUE)
    output.name7 <- myJoin(output.name6, args[[8]], by.x = rownames(output.name6), by.y = rownames(args[[8]]), all.x = TRUE, all.y = TRUE)
    output.name8 <- myJoin(output.name7, args[[9]], by.x = rownames(output.name7), by.y = rownames(args[[9]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name8, args[[10]], by.x = rownames(output.name8), by.y = rownames(args[[10]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==11) {
    ...
    output.name7 <- myJoin(output.name6, args[[8]], by.x = rownames(output.name6), by.y = rownames(args[[8]]), all.x = TRUE, all.y = TRUE)
    output.name8 <- myJoin(output.name7, args[[9]], by.x = rownames(output.name7), by.y = rownames(args[[9]]), all.x = TRUE, all.y = TRUE)
    output.name9 <- myJoin(output.name8, args[[10]], by.x = rownames(output.name8), by.y = rownames(args[[10]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name9, args[[11]], by.x = rownames(output.name9), by.y = rownames(args[[11]]), all.x = TRUE, all.y = TRUE)
  ...
  if (narg==12) {
    ...
    output.name8 <- myJoin(output.name7, args[[9]], by.x = rownames(output.name7), by.y = rownames(args[[9]]), all.x = TRUE, all.y = TRUE)
    output.name9 <- myJoin(output.name8, args[[10]], by.x = rownames(output.name8), by.y = rownames(args[[10]]), all.x = TRUE, all.y = TRUE)
    output.name10 <- myJoin(output.name9, args[[11]], by.x = rownames(output.name9), by.y = rownames(args[[11]]), all.x = TRUE, all.y = TRUE)
    output.name <- myJoin(output.name10, args[[12]], by.x = rownames(output.name10), by.y = rownames(args[[12]]), all.x = TRUE, all.y = TRUE)
