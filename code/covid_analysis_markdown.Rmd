...
We present two options for loading data: 
1. Download built count matrices from GEO: https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE150728
2. Download a processed Seurat object from the COVID-19 cell atlas: https://www.covid19cellatlas.org/#wilk20 
    # NOTE: If you wish to perform RNA velocity analysis, you will need to use option 1 as the Seurat object does not contain unspliced count matrices
